...
const AdventureCard: React.FC<AdventureCardProps> = ({ adventure, onBook }) => {
  ...
  return (
    <div className="group break-inside-avoid inline-block w-full mb-7 flex h-auto flex-col overflow-hidden rounded-[28px] border border-white/60 bg-white/40 shadow-[0_24_64px_rgba(8,42,62,.18),0_8px_16px_rgba(23,182,168,.08)] backdrop-blur-[5px] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_36px_100px_rgba(8,42,62,.24),0_12px_24px_rgba(23,182,168,.14)] sm:rounded-[32px]">
